...
export const Hero = () => {
  return (
    ...
    <div className="w-[375px] h-7 left-[80px] top-[39px] absolute justify-start items-start gap-20 inline-flex">
        <div className="text-white text-2xl font-medium font-['Ubuntu'] capitalize"><NavLink to="/"   
                           > 
                            Home 
                        </NavLink> </div>
        <div className="text-white text-2xl font-medium font-['Ubuntu'] capitalize"><Link to="/about"   
                           > 
                            About 
                        </Link> </div>
        <div className="text-white text-2xl font-medium font-['Ubuntu'] capitalize"><NavLink to="/courses"   
                           > 
                            Courses 
                        </NavLink> </div>
    </div>
